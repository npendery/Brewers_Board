...
User.create!(username: "npendery", city: "Cambridge, MA",
...
description: "Making great beer since 2009", location: "Boston, MA", owner: user1)

g2 = Group.create!(name: "AlterEgo Brewing",
description: "Bringing out the wort of us", location: "Cambridge, MA", owner: user2)
...
description: "Tasting the Apricot Ale at Tim's house", street: "130 Fairway Dr",
city: "Cambrdige", state: "MA", date: "2015/08/10", time: "3:00pm", user: user2,
group: g2)

Event.create!(title: "Trying the Pumpkin Ale!",
description: "Popping open our pumpkin ale just in time for Halloween!",
street: "1234 Mass Ave", city: "Cambrdige", state: "MA", date: "2015/10/28",
time: "9:00pm", user: user1, group: g1)

Event.create!(title: "Brewing this weekend!",
description: "First time attempting a British Bitter", street: "100 Summer St",
city: "Catonsville", state: "MD", date: "2015/10/30", time: "11:00am",
user: user3, group: g3)

Event.create!(title: "Brewing at Sahils!",
description: "Making a Belgian Blone Ale", street: "50 D St", city: "Washington",
state: "DC", date: "2015/10/10", time: "1:00pm", user: user4, group: g4)
